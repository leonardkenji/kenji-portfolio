...
{/* Content */}
    <div className="container mx-auto px-6 pt-30 relative z-10">
      <div className="grid lg:grid-cols-2">
        {/* Text about me  */}
        <div className="animate-fade-in">
          <h1 className="text-5xl">Hi, I am <span className="text-primary glow-text">Kenji</span>!</h1>
          <div className="mt-2 animation-delay-300">
            <p>Full Stack Software Developer and Marketing Specialist</p>
          </div>
          {/* Download CV BT  */}
          ...
          <div className="my-5 animation-delay-300 flex gap-4 items-center animate-fade-in">
            ...
            {[{ icon: <svg
              ...
              </svg>, href: "https://github.com/leonardkenji"},
              { icon: <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="currentColor"
              ...
              </svg>, href: "https://www.linkedin.com/in/leonardo-kenji-kawashita/"},
              { icon: <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="currentColor"
              ...
              </svg>, href: "https://www.instagram.com/leeokenji/"},
            ].map((social, index) => (
